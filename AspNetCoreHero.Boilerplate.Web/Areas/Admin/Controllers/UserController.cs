...
namespace AspNetCoreHero.Boilerplate.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : BaseController<UserController>
    {
        ...
        public async Task<IActionResult> OnGetSupportCreate()
        {
            return new JsonResult(new { isValid = true, html = await _viewRenderer.RenderViewToStringAsync("_CreateSupport", new SupportViewModel()) });
        }

        public async Task<IActionResult> OnSupportEdit()
        {
            return new JsonResult(new { isValid = true, html = await _viewRenderer.RenderViewToStringAsync("_EditSupport", new SupportViewModel()) });
        }
